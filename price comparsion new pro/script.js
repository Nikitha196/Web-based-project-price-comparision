...
const userMessage = [
    ...
    /* 1 */["How do you handle shipping and delivery?"],
    /* 2 */["Do you offer any customization or personalization options for your products?"],
    /* 3 */["What's the price range for your mobiles?","What's the price range for your laptop's","What's the price range for your shoes?"],
    /* 4 */["What type of product are you interested in selling?"],
    /* 5 */["What kind of warranty or support do you offer with your product?"],
    /* 6 */["who are you", "creator", "who is your creator", "who made you"],
  ...
  const botReply = [
    /* 0 */["Hello sir/mam ", "Hi ", "Hey! ", "Hi there! "],
    /* 1 */["you can visit the conserned website from which You have ordered "],
    /* 2 */["Yes, customers can customize [aspect of the product], such as colors or sizes."],
    /* 3 */[" Our prices typically range from 15000"," Our prices typically range from 30000"," Our prices typically range from 1000"],
    /* 4 */[" we'r selling mobile phones", " we'r selling laptops", " we'r selling shoes"],
    /* 5 */["What kind of warranty or support do you offer with your product?"],
    /* 6 */["i am a chatbot,i am here to clarify your queries"],
