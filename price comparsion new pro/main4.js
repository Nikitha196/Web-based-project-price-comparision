...
function item1(a) {
    ...
    if (a != select2) {
        ...
        document.getElementById("amazon1").innerHTML =  '<a href="' + product[a].link + '" target="_blank">' + product[a].link  + '</a>';
        document.getElementById("flipkat1").innerHTML =  '<a href="' + product[a].link + '" target="_blank">' + product[a].link  + '</a>';
        ...
        document.getElementById("amazon1").innerHTML = 
        document.getElementById("flipkat1").innerHTML =
...
function item2(a) {
    ...
    if (a != select1) {
        ...
        document.getElementById("amazon2").innerHTML =  '<a href="' + product[a].link + '" target="_blank">' + product[a].link  + '</a>';
        document.getElementById("flipkat2").innerHTML =  '<a href="' + product[a].link + '" target="_blank">' + product[a].link  + '</a>';
        ...
        document.getElementById("amazon2").innerHTML = 
        document.getElementById("flipkat2").innerHTML = 
